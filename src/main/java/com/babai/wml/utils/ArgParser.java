...
public class ArgParser {
	...
	private final String USAGE_STRING = """
			Usage: Preprocessor [-datadir path|-userdatadir path|-log-p[arse]|-log-j[son]|-warn-p[arse]|-log-level level|-s[erver]|-eut path|-i[nput] filename|-o[utput] filename|-include file|-h[elp]|-?]
			Options:
