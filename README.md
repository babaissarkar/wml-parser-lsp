...
Usage: wml [-hlsv] [-df] [-fm] [-log-p] [-warn-p] [-color=<'true'|'false'>] [-datadir=<dataPath>]
           ...
           [-parse=<parse>] [-userdatadir=<userDataPath>] [-i=<includes>]... [-q=<queries>]... [-d=NAME BODY]...
           [INPUT]
  ...
  -d, -define, --define=NAME BODY
      ...
      -fm, -fastMode, --fastMode
                            Fast Mode (skips macro expansion and parsing, only scraps data). Autoenabled internally
                              for -df/-gmr/-s.
  ...
  -q, -query, --query=<queries>
                            XPath-style WML query. Any tag/key matching this will be printed to stdout or file
                              pointed by -o.
