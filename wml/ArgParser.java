...
public class ArgParser {
	...
	public Path dataPath, inputPath, outputPath;
	public PrintStream out = null;
	
	// TODO this should be autogenerated
	private final String USAGE_STRING = """
			Usage: Preprocessor [-datadir|-log|-log-t[oken]|-log-p[arse]|-warn-p[arse]|-i[nput] filename|-o[utput] filename|-include file|-help|-?]
			Options:
